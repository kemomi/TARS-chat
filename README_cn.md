...
### 硬件准备
1. 看 [`schematics/README.md`](./schematics/README.md) 准备元件清单并完成接线
2. 看 [`stls/README.md`](./stls/README.md) 打印 3D 结构件
3. 装配机器人
...
欢迎提 Issue 与 PR!参与方式见 [`CONTRIBUTING.md`](./CONTRIBUTING.md)。
