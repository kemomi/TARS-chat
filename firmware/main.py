...
from firmware.src.llm_provider import create_provider
from firmware.src.dialogue import DialogueOrchestrator
...
def main():
    ...
    try:
        ...
        logger.warning(f"LLM 初始化失败,对话功能不可用: {e}")

    dialogue = DialogueOrchestrator(llm=llm, servo=servo, face=face, voice=voice)
